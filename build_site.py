...
- Story of one research line, for people and for AI (same content as the Atlas story view `#v=story&line=<line>`): {S}/lines/<line>.md and {S}/lines/<line>.json (line ids: O-ff-q3-family, O-dihedral-artin-family, ...)
